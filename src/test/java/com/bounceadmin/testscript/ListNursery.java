...
public class ListNursery extends SetUp {
	...
	public void filterNurseryByNameEmailCountryAndPhone() 
	{
		try
		{
			...
			String name = addnurserydataObj.nurseryFilterData()[0];
			String email = addnurserydataObj.nurseryFilterData()[2];
			String country = addnurserydataObj.nurseryFilterData()[0];
			String phone = addnurserydataObj.nurseryFilterData()[2];
	...
	public void filterNurseryByNameEmailCountryCountrycodeAndPhone() 
	{
		try
		{
			...
			String email = addnurserydataObj.nurseryFilterData()[2];
			String country = addnurserydataObj.nurseryFilterData()[0];
			String countryCode = addnurserydataObj.nurseryFilterData()[1];
			String phone = addnurserydataObj.nurseryFilterData()[2];
			String ph = countryCode.replaceAll("[^\\d+]", "")+" "+phone;
	...
	//@Test(priority=1) //edit nursery details,delete owner and add new owner
	public void editNursery()
	{
		try
		{
			...
			eTest.assignCategory("List, Edit and View Nursery");
			...
			addnurseryObj.accountHolderName.sendKeys("__edited");
			addnurseryObj.beneficiaryAddress.sendKeys("__edited");
			addnurseryObj.bankName.sendKeys("__edited");
