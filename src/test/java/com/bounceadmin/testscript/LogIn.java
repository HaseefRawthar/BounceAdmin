...
public class LogIn extends SetUp{
	...
	@Test(priority = 4)
	public void validLoginAsDarisniAdmin() //valid login with role=DarisniAdmin
	{
		try
		{
			log.info("Entered validLoginAsDarisniAdmin test");		
			eTest = eReports.createTest("Valid Login As DarisniAdmin");
			eTest.assignCategory("LogIn");	
			driver.navigate().refresh();
