...
public class AddStaff extends SetUp {
	...
	//@Test(priority=4)
	public void addStaffWithBothRoles() //add staff with both roles
	{
		try
		{
			actualArraylist = new ArrayList<String>();
			...
			eTest = eReports.createTest("Add Staff as BounceAdmin and CustomerSupportAgent");
			eTest.assignCategory("Staff");
