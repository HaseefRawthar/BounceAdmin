...
public class NotificationTemplateObject extends SetUp {
	...
	@FindBy(xpath="//datatable-body[1]/datatable-selection[1]/datatable-scroller[1]/datatable-row-wrapper[2]/datatable-body-row[1]/div[2]/datatable-body-cell[3]/div[1]//span[contains(text(),'instituion add password')]")
	...
	@FindBy(xpath="//datatable-body[1]/datatable-selection[1]/datatable-scroller[1]/datatable-row-wrapper[5]/datatable-body-row[1]/div[2]/datatable-body-cell[3]/div[1]//span[contains(text(),'nursery reset password')]")
	...
	@FindBy(xpath="//datatable-body[1]/datatable-selection[1]/datatable-scroller[1]/datatable-row-wrapper[14]/datatable-body-row[1]/div[2]/datatable-body-cell[3]/div[1]//span[contains(text(),'New Dars Institution Added')]")
